# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_ghtop.ipynb.

# %% auto 0
__all__ = ['ETYPES', 'term', 'tdim', 'get_sparklines', 'limit_cb', 'pct_comp', 'tail_events', 'watch_users', 'quad_logs',
           'simple', 'main']

# %% ../nbs/00_ghtop.ipynb 2
...
# %% ../nbs/00_ghtop.ipynb 6
def _exit(msg):
    print(msg, file=sys.stderr)
    sys.exit()

# %% ../nbs/00_ghtop.ipynb 8
